...
include 'config/config_grafico.inc';
...
$cores = [$azul, $verde, $vermelho, $amarelo, $laranja, $magenta, $ciano, $verde_escuro, $cinza];

include "config/conecta_banco.inc";
$res = $db->query("SELECT `descricao`,`valor` from receitas_despesas where 
`usuario`='$usuario' and `data`='$data_buscar' and (`tipo`='DF' or `tipo`='DV')");
